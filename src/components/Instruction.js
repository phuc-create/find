...
const Instruction = () => {
  return (
    <Fragment>
      <div className="ins">
        (Tiếng việt) <br />
        --Bạn sẽ nhận được một con số ngẫu nhiên từ 0000 đến 9999 <br />
        ...
        -- Số của bạn là: 0234 .Thì số Red Point là 1 (vì số 0 xuất hiện 1 lần
        đúng vị trí ) và Blue Point là 2 (vì số 0 đã xuất hiện trong lựa chọn
        của bạn nhưng sai ở 2 các vị trí khác)
        <br />{" "}
